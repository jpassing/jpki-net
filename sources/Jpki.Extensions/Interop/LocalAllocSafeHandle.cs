...
namespace Jpki.Interop
{
    ...
    /// </summary>
    internal sealed class LocalAllocSafeHandle : SafeHandleZeroOrMinusOneIsInvalid
    {
        ...
        {
            var safeLocalFree = NativeMethods.LocalAlloc(
                0,
                (UIntPtr)cb);
        ...
        {
            NativeMethods.LocalFree(this.handle);
            SetHandleAsInvalid();
            return true;
        }
